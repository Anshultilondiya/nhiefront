  ...
  render() {
    ...
    if (this.state.players) {
      player = this.state.players.map((el, index) => {
        return <Player key={index} name={el.data.name} sips={el.data.num} />;
      });
    }
    ...
    return (
      <div className="gamePage">
        <nav>
          ...
          <Button className="btn" variant="outline-success" onClick={this.exit}>
            <Link to={"/"}>Exit</Link>
          </Button>
        </nav>
            ...
            >
              <Col sm={4}>
                <div className="all-players">
                  <h1>All Players</h1>
                  <div>{this.state.players ? player : null}</div>
                </div>
              </Col>
              <Col sm={8}>
                <div className="your-status">
                  ...
                  <div className="ques">
                    <p>
                      A new question will be prompted every 0th or 30th second
                    </p>
                    <div>
                  ...
                  <div className="Card">
                    <div>
                      <Button
                        ...
                        variant="outline-success"
                        onClick={() => {
                          if (!this.state.drunk) this.drinks(this.state.sips);
                        }}
                      >
                        Drink
                      </Button>
